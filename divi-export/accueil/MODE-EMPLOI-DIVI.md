# Intégration Divi — Page Accueil

Voici la page Accueil découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
├── images/                 ← les 15 image(s) de la page (à uploader dans WordPress)
│   ├── img-001.png
│   ├── img-002.png
│   ├── img-003.png
│   ├── img-004.png
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← USToulouse
    ├── 03-section-2.html ← Union SportiveToulouse
    ├── 04-section-3.html ← Choisissez votre sport
    ├── 05-section-4.html ← slogan
    ├── 06-section-5.html ← Faites partie de l'aventure
    ├── 07-section-6.html ← Nos événements
    ├── 08-section-7.html ← L'actu du club
    ├── 09-section-8.html ← Nos partenaires
...
### 5️⃣ Le contenu de la page Accueil
