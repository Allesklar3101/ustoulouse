# Intégration Divi — Page Actualites

Voici la page Actualites découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← Actualités
    ├── 03-section-2.html ← actu-wrap
...
### 5️⃣ Le contenu de la page Actualites
