# Intégration Divi — Page Article

Voici la page Article découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← Première montée historique pour l'US Toulouse : un
    ├── 03-section-2.html ← Une dynamique construite match après match
    ├── 04-section-3.html ← Ne manquezaucune actualité
...
### 5️⃣ Le contenu de la page Article
