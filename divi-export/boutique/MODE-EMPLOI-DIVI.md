# Intégration Divi — Page Boutique

Voici la page Boutique découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
├── images/                 ← les 3 image(s) de la page (à uploader dans WordPress)
│   ├── img-001.png
│   ├── img-002.png
│   ├── img-003.png
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ├── 01-menu.html        ← menu (→ Theme Builder, pas dans la page)
    ├── 02-section-1.html ← LaBoutique
    ├── 03-section-2.html ← Nos articles
    ├── 04-section-3.html ← product-modal
    ├── 05-section-4.html ← float-cart
    ├── 06-section-5.html ← shop-pop
    ├── 07-section-6.html ← shop-pop
    ├── 08-section-7.html ← toast
...
### 5️⃣ Le contenu de la page Boutique
