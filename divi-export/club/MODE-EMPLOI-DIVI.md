# Intégration Divi — Page Club

Voici la page Club découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
├── images/                 ← les 21 image(s) de la page (à uploader dans WordPress)
│   ├── img-001.png
│   ├── img-002.png
│   ├── img-003.png
│   ├── img-004.png
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← Union SportiveToulouse
    ├── 03-section-2.html ← Union SportiveToulouse
    ├── 04-section-3.html ← UST en quelques chiffres
    ├── 05-section-4.html ← Nos sports
    ├── 06-section-5.html ← Le Club
    ├── 07-section-6.html ← slogan
    ├── 08-section-7.html ← Nos valeurs
    ├── 09-section-8.html ← Notre staff
    ├── 10-section-9.html ← Nos engagements
    ├── 11-section-10.html ← Nos partenaires
...
### 5️⃣ Le contenu de la page Club
