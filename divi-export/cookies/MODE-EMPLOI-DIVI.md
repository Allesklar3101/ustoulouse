# Intégration Divi — Page Cookies

Voici la page Cookies découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← Politiquede Cookies
    ├── 03-section-2.html ← Qu'est-ce qu'un cookie ?
...
### 5️⃣ Le contenu de la page Cookies
