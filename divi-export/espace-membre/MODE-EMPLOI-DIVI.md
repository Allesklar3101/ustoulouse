# Intégration Divi — Page Espace Membre

Voici la page Espace Membre découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
├── images/                 ← les 4 image(s) de la page (à uploader dans WordPress)
│   ├── img-001.png
│   ├── img-002.png
│   ├── img-003.png
│   ├── img-004.png
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← EspaceMembre
    ├── 03-section-2.html
    ├── 04-section-3.html
    ├── 05-section-4.html
...
### 5️⃣ Le contenu de la page Espace Membre
