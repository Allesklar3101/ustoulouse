# Intégration Divi — Page Football

Voici la page Football découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
├── images/                 ← les 9 image(s) de la page (à uploader dans WordPress)
│   ├── img-001.png
│   ├── img-002.png
│   ├── img-003.png
│   ├── img-004.png
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← Football
    ├── 03-section-2.html ← Football à l'UST
    ├── 04-section-3.html ← Résultats & Classement
    ├── 05-section-4.html ← Infos pratiques
    ├── 06-section-5.html ← La section en images
...
### 5️⃣ Le contenu de la page Football
