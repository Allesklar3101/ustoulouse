# Intégration Divi — Page Mentions Legales

Voici la page Mentions Legales découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← MentionsLégales
    ├── 03-section-2.html ← Éditeur du site
...
### 5️⃣ Le contenu de la page Mentions Legales
