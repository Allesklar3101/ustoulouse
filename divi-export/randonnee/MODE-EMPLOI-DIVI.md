# Intégration Divi — Page Randonnee

Voici la page Randonnee découpée et prête pour Divi. Les images sont sorties du code (fini le base64 de 30 MB !).
...
├── images/                 ← les 19 image(s) de la page (à uploader dans WordPress)
│   ├── img-001.png
│   ├── img-002.png
│   ├── img-003.png
│   ├── img-004.png
...
└── blocs/                  ← les blocs HTML à coller dans des modules Code
    ...
    ├── 02-section-1.html ← Randonnée
    ├── 03-section-2.html ← Randonnée à l'UST
    ├── 04-section-3.html ← Deux activités, une communauté
    ├── 05-section-4.html ← slogan
    ├── 06-section-5.html ← Infos pratiques
    ├── 07-section-6.html ← La section en images
    ├── 08-section-7.html
...
### 5️⃣ Le contenu de la page Randonnee
